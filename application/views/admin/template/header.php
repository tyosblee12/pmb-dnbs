...
<head>
    ...
    <title>PMB Dashboard &mdash; STMIK Dharma Negara</title>
    ...
    <div id="app">
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?php echo base_url('asset/admin/img/products/product-3-50.png');?>"
                                        alt="product">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?php echo base_url('asset/admin/img/products/product-2-50.png');?>"
                                        alt="product">
                                    Drone X2 New Gen-7
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?php echo base_url('asset/admin/img/products/product-1-50.png');?>"
                                        alt="product">
                                    Headphone Blitz
                                </a>
                            </div>
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('asset/admin/img/avatar/avatar-1.png');?>"
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('asset/admin/img/avatar/avatar-2.png');?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Dedik Sugiharto</b>
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="
                                            <?php echo base_url('asset/admin/img/avatar/avatar-3.png');?>"
                                            class="rounded-circle">
                                        <div class="is-online"></div>
                                    </div>
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('asset/admin/img/avatar/avatar-4.png');?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('asset/admin/img/avatar/avatar-5.png');?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Alfa Zulkarnain</b>
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <img alt="image" src="<?php echo base_url('asset/admin/img/avatar/user.png');?>"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?php echo base_url();?>" class="dropdown-item has-icon text-danger">
            ...
            <div class="main-sidebar ">
                <aside id="sidebar-wrapper navbar-bg">
                    <div class="sidebar-brand ">
                        <a href="#">PMB Dharma Negara</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link beep beep-sidebar" href="#">Empty
                                        State</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="#">Setting Detail</a></li>
