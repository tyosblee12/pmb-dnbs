...
<head>
    ...
    <title>Login &mdash; PMB Dharma Negara</title>
...
<body>
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo base_url('index.php/admin');?>"
                                    ...
                                    <div class="g-recaptcha mb-3"
                                        data-sitekey="6Lcu8qYaAAAAAF1Vc8rx1REFXTAwT_bDXEakalF6">
                                    </div>
                                    <div class="form-group">
    ...
    if (!$captcha) {
        ...
        $response = file_get_contents(
            "https://www.google.com/recaptcha/api/siteverify?secret=6Lcu8qYaAAAAAG7rSXO5x-f2S6IKpcsy9v1NFX62&response="
            .$captcha
            .
